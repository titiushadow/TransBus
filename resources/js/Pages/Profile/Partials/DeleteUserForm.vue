    ...
    <section class="space-y-6">
        <header>
            ...
            <p class="mt-1 text-sm text-gray-600 text-justify">
                Depois que sua conta for excluída, todos os seus recursos e dados serão excluídos permanentemente. Antes de deletar
                sua conta, faça o download de quaisquer dados ou informações que deseja reter.
            </p>
        </header>
